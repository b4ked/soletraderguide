...
There are three main things you need to do before April 2026: [choose MTD-compatible software](/tools/mtd-software-chooser), [set up digital records](/mtd-for-sole-traders/records-you-need-to-keep), and formally [sign up for MTD through your Government Gateway account](/mtd-for-sole-traders/what-is-mtd-income-tax). Leaving any of these steps to the last minute increases the risk of problems when the deadline arrives.
