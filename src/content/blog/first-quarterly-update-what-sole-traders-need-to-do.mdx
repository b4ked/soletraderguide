...
Before your first update is due, you need [MTD-compatible software](/tools/mtd-software-chooser) connected to your HMRC account. Log in to your [Government Gateway](/mtd-for-sole-traders/what-is-mtd-income-tax), navigate to the MTD for Income Tax service, and follow the sign-up process. You will be asked to authorise your chosen software to communicate with HMRC on your behalf — most software platforms walk you through this process with clear on-screen instructions.
