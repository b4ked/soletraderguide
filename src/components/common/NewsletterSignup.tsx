...
export function NewsletterSignup({
  heading = 'Stay ahead of MTD',
  subtext = 'Monthly updates for UK sole traders — deadline reminders, tax tips, and software news. No spam. Unsubscribe anytime.',
  className = '',
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Thanks for subscribing. We&apos;ll only send you useful MTD updates.
            </p>
          </div>
        </div>
      ) : (
