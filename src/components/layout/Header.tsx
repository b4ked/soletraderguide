      ...
      >
        <div className="page-container">
          <div className="flex h-16 items-center justify-between">
            ...
            {/* Desktop CTA — driven by siteConfig.headerCta or siteConfig.mobileCta */}
            {(siteConfig.headerCta ?? siteConfig.mobileCta) && (
              <div className="hidden lg:flex items-center gap-3">
                <Link
                  href={(siteConfig.headerCta ?? siteConfig.mobileCta)!.href}
                  className={cn(
                ...
                >
                  {(siteConfig.headerCta ?? siteConfig.mobileCta)!.label}
                </Link>
              </div>
            )}
