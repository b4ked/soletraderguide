      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border">
          <Link
            ...
            {...{}}
          >
            <span className="text-lg font-bold text-brand">{siteConfig.name}</span>
            {siteConfig.domainSuffix && (
              <span className="text-xs text-muted-foreground">{siteConfig.domainSuffix}</span>
            )}
          </Link>
          <button
            onClick={onClose}
        ...
        <div className="px-4 py-4 border-t border-border">
          <Link
            href={siteConfig.mobileCta?.href ?? '/comparisons'}
            onClick={onClose}
          ...
          >
            {siteConfig.mobileCta?.label ?? 'Compare'}
          </Link>
